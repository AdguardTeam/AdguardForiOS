...
@property(nonatomic, readonly) NSUInteger startTime; /**< Time when dnsproxy started processing request (epoch in milliseconds) */
@property(nonatomic, readonly) NSUInteger elapsed; /**< Time elapsed on processing */
