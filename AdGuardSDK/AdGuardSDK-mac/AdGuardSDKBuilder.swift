...
public class AdGuardSDKBuilder: AdGuardSDKBuilderProtocol {
    ...
    public init (filtersStorageUrl: URL, dbUrl: URL) {
        let configuration = SafariConfiguration(iosVersion: 13, currentLanguage: "en", proStatus: false, safariProtectionEnabled: true, advancedBlockingIsEnabled: true, blocklistIsEnabled: true, allowlistIsEnbaled: true, allowlistIsInverted: false, appBundleId: Bundle.main.bundleIdentifier ?? "", appProductVersion: "", appId: "builder", cid: "")
