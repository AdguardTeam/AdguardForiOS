...
class FilterFilesStorageMock: FilterFilesStorageProtocol {
    ...
    var invokedGetUrlForFilter = false
    var invokedGetUrlForFilterCount = 0
    ...
    func getUrlForFilter(withId id: Int) -> URL {
        ...
        invokedGetUrlForFilterParameter = id
        invokedGetUrlForFilterParametersList.append(id)
        return stubbedGetUrlForFilterResult
    }
}
