...
public protocol SafariProtectionUserRulesProtocol {
     ...
     */
    func add(rule: UserRuleProtocol, for type: SafariUserRuleType, override: Bool, onRuleAdded: @escaping (_ error: Error?) -> Void)
     ...
     */
    func add(rules: [UserRuleProtocol], for type: SafariUserRuleType, override: Bool, onRulesAdded: @escaping (_ error: Error?) -> Void)
     ...
     */
    func modifyRule(_ oldRuleText: String, _ newRule: UserRuleProtocol, for type: SafariUserRuleType, onRuleModified: @escaping (_ error: Error?) -> Void)
     ...
     */
    func removeRule(withText ruleText: String, for type: SafariUserRuleType, onRuleRemoved: @escaping (_ error: Error?) -> Void)
     ...
     */
    func removeAllRules(for type: SafariUserRuleType, onRulesRemoved: @escaping (_ error: Error?) -> Void)
}
...
extension SafariProtection {
    ...
    public func add(rule: UserRuleProtocol, for type: SafariUserRuleType, override: Bool, onRuleAdded: @escaping (_ error: Error?) -> Void) {
    ...
    public func add(rules: [UserRuleProtocol], for type: SafariUserRuleType, override: Bool, onRulesAdded: @escaping (Error?) -> Void) {
        workingQueue.async { [weak self] in
            guard let self = self else {
    ...
    public func modifyRule(_ oldRuleText: String, _ newRule: UserRuleProtocol, for type: SafariUserRuleType, onRuleModified: @escaping (Error?) -> Void) {
        workingQueue.async { [weak self] in
            guard let self = self else {
    ...
    public func removeRule(withText ruleText: String, for type: SafariUserRuleType, onRuleRemoved: @escaping (Error?) -> Void) {
        workingQueue.async { [weak self] in
            guard let self = self else {
    ...
    public func removeAllRules(for type: SafariUserRuleType, onRulesRemoved: @escaping (Error?) -> Void) {
        workingQueue.async { [weak self] in
            guard let self = self else {
