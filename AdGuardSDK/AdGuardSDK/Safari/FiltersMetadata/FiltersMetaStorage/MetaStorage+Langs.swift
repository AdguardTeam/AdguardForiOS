...
extension MetaStorage: LangsMetaStorageProtocol {
    ...
    func getLangsForFilter(withId id: Int) throws -> [String] {
        ...
        LOG.debug("(FiltersMetaStorage) - getLangsForFilter returning \(result.count) langs objects for filter with id=\(id)")
        return result
    }
    ...
    func updateAll(langs: [String], forFilterWithId id: Int) throws {
        ...
        LOG.debug("(FiltersMetaStorage) - updateAll langs; deleted \(deletedRows) rows")
    }
    ...
    func update(lang: String, forFilterWithId id: Int) throws {
        ...
        LOG.debug("(FiltersMetaStorage) -  Insert row with filterID \(id) and lang \(lang)")
    }
    ...
    func deleteLangsForFilters(withIds ids: [Int]) throws {
        ...
        let deletedRows = try filtersDb.run(langsToDelete.delete())
        LOG.debug("(FiltersMetaStorage) - deleteLangsForFilters; deleted \(deletedRows) filters")
    }
}
