...
extension RequestFactory {
    static func loadFiltersMetadataConfig()->RequestConfig<FiltersMetadataParser> {
        return RequestConfig<FiltersMetadataParser>(request: FiltersMetadataRequest(), parser: FiltersMetadataParser())
    }
