...
- (void) requestResetStatisticsWithCompletionBlock:(void(^)(BOOL))completionBlock {
    ...
    NSString* message = ACLocalizedString(@"reset_statistics", @"(APUIDnsRequestsController) Reset dns requests statistics alert text");
    
    UIAlertController* alertController = [UIAlertController alertControllerWithTitle:nil
                                                                   message:message
                                                            preferredStyle:UIAlertControllerStyleAlert];
    
    UIAlertAction* yesAction = [UIAlertAction actionWithTitle:ACLocalizedString(@"clear_log_and_statistic_action", @"DNS Request log-> Reset -> Clear DNS log and statistic option.") style:UIAlertActionStyleDestructive
    ...
    UIAlertAction* noAction = [UIAlertAction actionWithTitle:ACLocalizedString(@"clear_log_action", @"DNS Request log-> Reset -> Clear DNS log only option.") style:UIAlertActionStyleDefault
                                                      handler:^(UIAlertAction * action) {
    ...
    UIAlertAction* cancelAction = [UIAlertAction actionWithTitle:ACLocalizedString(@"common_action_cancel", @"Cancel Button caption in alert") style:UIAlertActionStyleCancel
                                                     handler:^(UIAlertAction * action) {
