  ...
  var makePredictionPath = function (elem) {
    ...
    */
    ...
    var setupEventHandlers = function () {
      ...
      // sgIgnore.on("mouseout", iosPreventEventHandler);
      // sgIgnore.on("mousemove", iosPreventEventHandler);
      // sgIgnore.on("click", iosPreventEventHandler);
      ...
      document.addEventListener("unload", api.close);

      //        sgIgnore.on("mouseover", sgMouseoverHandler);
      //        sgIgnore.on("mouseout", sgMouseoutHandler);
      //        sgIgnore.on("click", sgMouseoverHandler);
    };
      ...
      var deleteEventHandlers = function () {
        ...
        var elements = $("body *");
        elements.off("mouseover", iosPreventEventHandler);
        elements.off("mouseout", iosPreventEventHandler);
        elements.off("mousemove", iosPreventEventHandler);
        elements.off("click", iosPreventEventHandler);

        elements.off("touchend", iosElementTouchendHandler);
        elements.off("mouseup", iosElementSelectHandler);
        elements.off("mousedown", iosElementSelectHandler);
        //        elements.off("mouseout", sgMouseoutHandler);
        //        elements.off("click", sgMouseoverHandler);
      };
