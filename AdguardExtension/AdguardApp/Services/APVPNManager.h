...
/**
 Obtains DNS requests statistics,
 and calls `completionBlock` with appropriate parameter.
 */
- (void)obtainDnsLogStatistics:(nonnull void (^)(NSDictionary<NSString*, NSArray<RequestsStatisticsBlock *> *> * _Nullable statistics))completionBlock;
