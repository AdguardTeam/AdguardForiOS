...
@objc protocol SafariProtectionServiceProtocol {
    @objc var safariProtectionEnabled: Bool { get }
}

@objc class SafariProtectionService: NSObject, SafariProtectionServiceProtocol {
