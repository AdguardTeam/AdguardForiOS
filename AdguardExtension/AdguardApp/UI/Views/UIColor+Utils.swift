...
extension UIColor {
    struct AdGuardColor {
        ...
        static let logBlockedCellColor: UIColor = #colorLiteral(red: 0.2, green: 0.8745098039, blue: 0.2196078431, alpha: 0.05) //hex = #33df38 alpha: 12
        static let logSelectedCellColor: UIColor = #colorLiteral(red: 0.3019607843, green: 0.8745098039, blue: 0.2196078431, alpha: 0.05) //hex = #4ddf38 alpha: 12
