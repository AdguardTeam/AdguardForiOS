...
class LowLevelSettingsController: UITableViewController {
    ...
    private func setupWarningDescriptionTextView() {
        ...
        warningTextView.setAttributedTitle(warningDescription, fontSize: warningTextView.font!.pointSize, color: theme.blackTextColor, attachmentImage: nil, textAlignment: .center)
    }
