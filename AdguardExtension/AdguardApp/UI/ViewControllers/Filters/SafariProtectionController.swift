    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case whiteListSegue:
            if let controller = segue.destination as? ListOfRulesController{
                ...
                let model = ListOfRulesModel(listOfRulesType: type, resources: resources, contentBlockerService: contentBlockerService, antibannerController: antibannerController, theme: theme, dnsFiltersService: dnsFiltersService)
                controller.model = model
            }
            
        case blackListSegue:
            if let controller = segue.destination as? ListOfRulesController{
                let model = ListOfRulesModel(listOfRulesType: .safariUserFilter, resources: resources, contentBlockerService: contentBlockerService, antibannerController: antibannerController, theme: theme, dnsFiltersService: dnsFiltersService)
                controller.model = model
            }
