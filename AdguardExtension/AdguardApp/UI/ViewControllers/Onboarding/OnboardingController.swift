...
class OnboardingController: UIViewController {
    ...
    private func setupLabels() {
        settingsLabel.setAttributedTitle(String.localizedString("onboarding_first_step_text"), fontSize: settingsLabel.font!.pointSize, color: theme.grayTextColor, attachmentImage: nil)
        
        safariLabel.setAttributedTitle(String.localizedString("onboarding_second_step_text"), fontSize: safariLabel.font!.pointSize, color: theme.grayTextColor, attachmentImage: nil)
        
        switchLabel.setAttributedTitle(String.localizedString("onboarding_third_step_text"), fontSize: switchLabel.font!.pointSize, color: theme.grayTextColor, attachmentImage: nil)
    }
