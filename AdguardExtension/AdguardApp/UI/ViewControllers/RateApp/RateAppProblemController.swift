...
class RateAppProblemController: BottomAlertController {
    ...
    private func setupDescriptionTextView() {
        ...
        descriptionTextView.setAttributedTitle(problemDescription, fontSize: descriptionTextView.font!.pointSize, color: theme.blackTextColor, attachmentImage: nil, textAlignment: .center)
    }
}
