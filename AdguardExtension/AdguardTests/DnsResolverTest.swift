...
class DnsResolverTest: XCTestCase {
    ...
    var testCases: [String: DnsResolverProtocol.DnsResolverResult] = [
        ...
        "sdns://AAAAAAAAAAAABzguOC44Ljg": ("8.8.8.8:53", .dns),
        "sdns://AAAAAAAAAAAADVsyNjIwOmZlOjpmZV0": ("[2620:fe::fe]:53", .dns),
        "sdns://AAAAAAAAAAAADTkyLjIyMy4xMDkuMzE": ("92.223.109.31:53", .dns),
        "sdns://AAAAAAAAAAAAEVsyNjIwOjc0OjFiOjoxOjFd": ("[2620:74:1b::1:1]:53", .dns),
