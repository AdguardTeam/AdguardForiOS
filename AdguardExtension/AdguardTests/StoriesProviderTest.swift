...
class StoriesProviderTest: XCTestCase {
    ...
    func testStoryCategoriesAreNotMissing() {
        ...
        let jsonCategories = json["categories"] as! [String]
        XCTAssertEqual(jsonCategories.count, StoryGroupType.allCases.count)
