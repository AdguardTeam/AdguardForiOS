...
class DnsProxyTest: XCTestCase {
    ...
    override func setUp() {
        XCTAssert(proxyService.start(upstreams: ["1.1.1.1"], listenAddr: "127.0.0.1", bootstrapDns: "8.8.8.8", fallback: "8.8.8.8", serverName: "cloudflare", filtersJson: "", maxQueues: 5, ipv6Available: true))
    }
