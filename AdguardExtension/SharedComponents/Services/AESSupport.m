...
- (void)sendMailBugReportWithParentController:(UIViewController *)parent{
    ...
    if ([MFMailComposeViewController canSendMail]) {
        @autoreleasepool {
            ...
            [compose setSubject:[NSString stringWithFormat:AESSupportSubjectPrefixFormat, AE_PRODUCT_NAME, NSLocalizedString(@"action_bug_report", @"(AEUIAboutController) Subject field for mail bug report")]];
        ...
        [ACSSystemUtils showSimpleAlertForController:parent withTitle:NSLocalizedString(@"common_error_title", @"")
                                             message:NSLocalizedString(@"bug_report_sending_error", @"(AEUIAboutController) Alert message if user have no e-mail account on device")];
    }
}
...
- (void)sendSimpleMailWithParentController:(UIViewController *)parent subject:(NSString *)subject body:(NSString *)body{
    ...
    if ([MFMailComposeViewController canSendMail]) {
        ...
        [ACSSystemUtils showSimpleAlertForController:parent withTitle:NSLocalizedString(@"common_error_title", @"")
                                             message:NSLocalizedString(@"support_message_sending_error", @"(AEUIAboutController) Alert message if user have no e-mail account on device")];
    }
