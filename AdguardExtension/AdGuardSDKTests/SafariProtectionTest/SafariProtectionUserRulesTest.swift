...
class SafariProtectionUserRulesTest: XCTestCase {
    ...
    func testRulesString() {
        let blocklistManager = userRulesManagersProvider.blocklistRulesManagerMock
        testRulesString(blocklistManager)
        
        let allowlistManager = userRulesManagersProvider.allowlistRulesManagerMock
        testRulesString(allowlistManager)
        
        let invertedAllowlistManager = userRulesManagersProvider.invertedAllowlistRulesManagerMock
