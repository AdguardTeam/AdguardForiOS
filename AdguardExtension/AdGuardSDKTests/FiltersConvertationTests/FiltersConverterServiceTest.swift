...
class FiltersConverterServiceTest: XCTestCase {
    ...
    var managersProvider: UserRulesManagersProviderMock!
    ...
    override func setUp() {
        ...
        managersProvider = UserRulesManagersProviderMock()
        converterService = FiltersConverterService(configuration: configuration, filtersService: filtersService, filterFilesStorage: filesStorage, userRulesManagersProvider: managersProvider, filtersConverter: filtersConverter)
    }
    ...
    func testConvertionWithSuccess() {
        ...
        (managersProvider.allowlistRulesManager as! AllowlistRulesManagerMock).allRules = allowRules
        
        let invAllowRules = [UserRule(ruleText: "inv_allow_rule_1", isEnabled: false), UserRule(ruleText: "inv_allow_rule_2", isEnabled: true)]
        (managersProvider.invertedAllowlistRulesManager as! InvertedAllowlistRulesManagerMock).allRules = invAllowRules
