        ...
        return regenerator_default().wrap(function _callee20$(_context20) {
          while (1) switch (_context20.prev = _context20.next) {
            ...
            case 2:
              ...
              _ref2 = result, protectionEnabled = _ref2.protection_enabled, hasUserRules = _ref2.has_user_rules, premiumApp = _ref2.premium_app, appearanceTheme = _ref2.appearance_theme, contentBlockersEnabled = _ref2.content_blockers_enabled, advancedBlockingEnabled = _ref2.advanced_blocking_enabled, allowlistInverted = _ref2.allowlist_inverted, platform = _ref2.platform, safariProtectionEnabled = _ref2.safari_protection_enabled, enableSiteProtectionLink = _ref2.enable_site_protection_link, disableSiteProtectionLink = _ref2.disable_site_protection_link, addToBlocklistLink = _ref2.add_to_blocklist_link, removeAllBlocklistRulesLink = _ref2.remove_all_blocklist_rules_link, upgradeAppLink = _ref2.upgrade_app_link, reportProblemLink = _ref2.report_problem_link, enableAdvancedBlockingLink = _ref2.enable_advanced_blocking_link, enableSafariProtectionLink = _ref2.enable_safari_protection_link;
              _context20.next = 6;
...
var adguard_adguard = new AdGuard();
// @ts-ignore
__webpack_require__.g.adguard = adguard_adguard;
 ...
 */
function extended_css_esm_defineProperty(obj, key, value) {
  if (key in obj) {
    Object.defineProperty(obj, key, {
      value: value,
      enumerable: true,
...
class AnySelectorNode {
   ...
   */
  constructor(type) {
    extended_css_esm_defineProperty(this, "children", []);
...
class AbsolutePseudoClassNode extends AnySelectorNode {
  ...
  constructor(name) {
    ...
    extended_css_esm_defineProperty(this, "value", '');
...
extended_css_esm_defineProperty(ThrottleWrapper, "THROTTLE_DELAY_MS", 150);
...
class EventTracker {
   ...
   */
  constructor() {
    extended_css_esm_defineProperty(this, "getLastEventType", () => this.lastEventType);

    extended_css_esm_defineProperty(this, "getTimeSinceLastEvent", () => {
...
class BackgroundScript {
  ...
  static async executeScript(scriptInjection) {
    const results = await browser_polyfill.scripting.executeScript(scriptInjection);
    if (results.length === 0) {
  ...
  static async runScriptlet(tabId, frameId, scriptlet) {
    ...
    const scriptletFunction = scriptlets_scriptlets.getScriptletFunction(scriptlet.name);
...
var Engine = /*#__PURE__*/_createClass(function Engine() {
   ...
   */
  this.backgroundScript = new BackgroundScript();
   ...
   */
  this.getFromCache = function (url, topUrl) {
    var key = _this.cacheKey(url, topUrl);

    var cachedData = _this.cache.get(key);

    if (cachedData) {
      // Make sure to copy the object so that the user wouldn't be able
      // to mutate the cached data.
      var data = engine_objectSpread({}, cachedData);
   ...
   */
  this.saveToCache = function (url, topUrl, data) {
    var key = _this.cacheKey(url, topUrl);

    _this.cache.set(key, engine_objectSpread(engine_objectSpread({}, data), {}, {
      // Mark as cached.
      cached: true
    }));
  };
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(url, topUrl) {
      ...
      return regenerator_default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return adguard_adguard.nativeHost.getContentScriptData(url, topUrl);
          ...
          case 2:
            ...
            _this.saveToCache(url, topUrl, data);
  ...
  this.lookup = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(url, topUrl) {
      ...
      return regenerator_default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            cachedData = _this.getFromCache(url, topUrl); // If the data is already cached, return it.
   ...
   * @param configuration Configuration to apply.
   */
  this.applyConfiguration = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(tabId, frameId, configuration) {
      return regenerator_default().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _this.backgroundScript.applyConfiguration(tabId, frameId, configuration);
...
var handleMessages = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(message, sender) {
    var type, data, tabId, _yield$browser$tabs$q3, _yield$browser$tabs$q4, tab, url, allSitesAllowed, permissionsModalViewed, _yield$adguard$native2, protectionEnabled, hasUserRules, premiumApp, appearanceTheme, contentBlockersEnabled, advancedBlockingEnabled, safariProtectionEnabled, allowlistInverted, platform, enabled, _url, _url2, _url3, _url4, _sender$tab$id, _sender$tab, _sender$frameId, _sender$tab2, _tabId, frameId, blankFrame, _url5, topUrl, contentScriptData;
    ...
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          log_log.error('Was unable to get active tab');
        ...
        case 30:
          permissionsModalViewed = _context.sent;
          _context.next = 33;
          return adguard_adguard.nativeHost.getInitData(url);
        ...
        case 44:
          ...
          return _context.abrupt("return", adguard_adguard.nativeHost.enableProtection(_url));

        case 47:
          return _context.abrupt("return", adguard_adguard.nativeHost.disableProtection(_url));

        case 48:
          _url2 = data.url;
          return _context.abrupt("return", adguard_adguard.nativeHost.enableSafariProtection(_url2));

        case 50:
          _url3 = data.url;
          return _context.abrupt("return", adguard_adguard.nativeHost.reportProblem(_url3));

        case 52:
          _context.next = 54;
          return adguard_adguard.nativeHost.upgradeMe();
        ...
        case 55:
          _context.next = 57;
          return adguard_adguard.nativeHost.enableAdvancedBlocking();
        ...
        case 58:
          _url4 = data.url;
          _context.next = 61;
          return adguard_adguard.nativeHost.removeUserRulesBySite(_url4);

        case 61:
          return _context.abrupt("break", 77);

        case 62:
          _tabId = (_sender$tab$id = (_sender$tab = sender.tab) === null || _sender$tab === void 0 ? void 0 : _sender$tab.id) !== null && _sender$tab$id !== void 0 ? _sender$tab$id : 0;
          frameId = (_sender$frameId = sender.frameId) !== null && _sender$frameId !== void 0 ? _sender$frameId : 0;
          blankFrame = false;
          _url5 = sender.url || '';
          topUrl = frameId === 0 ? undefined : (_sender$tab2 = sender.tab) === null || _sender$tab2 === void 0 ? void 0 : _sender$tab2.url;
          ...
          _context.next = 70;
          return engine.lookup(_url5, topUrl);
        ...
        case 70:
          ...
          _context.next = 74;
          return engine.applyConfiguration(_tabId, frameId, contentScriptData.configuration);
        ...
        case 75:
          return _context.abrupt("return", contentScriptData);
...
var background = function background() {
  ...
  browser_polyfill_default().runtime.onMessage.addListener( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(message, sender) {
      return regenerator_default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", handleMessages(message, sender));
